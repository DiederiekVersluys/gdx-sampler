	...
	public void create() {
		...
		InputAdapter firstProcessor = new InputAdapter(){
			...
			public boolean keyTyped(char character){
				log.debug("first keyDown character = "+character);
				return false;
			}
		...
		InputAdapter secondProcessor = new InputAdapter(){
			...
			@Override
			public boolean keyTyped(char character){
				log.debug("second keyDown character = "+character);
				return false;
			}
		};
...
//		Gdx.input.setInputProcessor(this);
	...
	public boolean touchDown(int screenX, int screenY, int pointer, int button) {
		String message = "touchDown screen x= "+screenX + "screen y= "+screenY;
		log.debug(message);
		addMessage(message);
		return true;
	}
	...
	public boolean touchDragged(int screenX, int screenY, int pointer) {
		String message = "touchDragged screen x= "+screenX + "screen y= "+screenY;
		log.debug(message);
		addMessage(message);
		return true;
	}
	...
	public boolean mouseMoved(int screenX, int screenY) {
		String message = "MouseMoved screen x= "+screenX + "screen y= "+screenY;
		log.debug(message);
		addMessage(message);
		return true;
	}
	...
	public boolean scrolled(float amountX, float amountY) {
		String message = "Scrolled amount= "+amountX+ "Scrolled amount= "+amountY;
		log.debug(message);
		addMessage(message);
		return true;
	}
